    ...
    <div className="min-w-0 space-y-4 md:space-y-6">
      ...
      {showAnalytics && (
        <section className="min-w-0 overflow-hidden rounded-[22px] border border-border/60 bg-white/75 shadow-sm dark:bg-white/5 md:rounded-[26px]">
          <div className="border-b border-border/50 bg-white/50 px-4 py-3.5 md:px-5 md:py-4 dark:bg-white/3">
          ...
          <div className="space-y-4 p-3.5 md:space-y-5 md:p-5">
            <div className="grid min-w-0 grid-cols-1 gap-3 md:grid-cols-3">
              {[
                ...
                <div key={card.label} className={cn("min-w-0 rounded-[20px] border border-border/50 bg-white/72 px-4 py-3.5 shadow-sm dark:bg-white/4 md:rounded-2xl md:py-4", isLoadingAnalytics && "animate-pulse")}>
            ...
            <div className="min-w-0 rounded-[20px] border border-border/50 bg-white/72 px-4 py-3.5 shadow-sm dark:bg-white/4 md:rounded-2xl md:py-4">
      ...
      {showLogicControls && (
        <section className="space-y-3 overflow-hidden rounded-[26px] border border-border/60 bg-white/75 p-4 shadow-sm dark:bg-white/5 md:p-5">
          ...
          <div className="flex flex-col gap-4 rounded-2xl border border-border/50 bg-white/72 px-4 py-4 shadow-sm dark:bg-white/4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <section className="space-y-4 overflow-hidden rounded-[26px] border border-border/60 bg-white/75 p-4 shadow-sm dark:bg-white/5 md:p-5">
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
          <div className="rounded-3xl border border-border/60 bg-white/75 p-4 shadow-sm dark:bg-white/5 sm:p-5">
            ...
            <div className="mt-4 space-y-3">
              {showDangerZone && (
                <div className="rounded-2xl border border-border/50 bg-white/72 p-3.5 dark:bg-white/4">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-border/60 bg-white/84 px-4 text-sm font-black text-foreground transition-all hover:border-primary/25 hover:text-primary dark:bg-white/6"
                    >
                      <Upload size={14} />
                      选择备份包
                    </button>
          ...
          <div className="rounded-3xl border border-border/60 bg-white/75 p-4 shadow-sm dark:bg-white/5 sm:p-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="inline-flex w-fit rounded-full border border-border/60 bg-white/72 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-muted-foreground/70 dark:bg-white/4">
                配额 {backups.length} / {backupRetention}
              </div>
            </div>
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-border/50 bg-white/72 px-4 py-4 dark:bg-white/4">
        ...
        {showDangerZone ? (
          <div className="space-y-4">
            <div className="rounded-3xl border border-border/60 bg-white/75 p-4 shadow-sm dark:bg-white/5 sm:p-5">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-3">
                <div className="rounded-2xl border border-border/50 bg-white/72 p-4 dark:bg-white/4">
            ...
            <div className="rounded-3xl border border-border/60 bg-white/75 p-4 shadow-sm dark:bg-white/5 sm:p-5">
              <div role="button" tabIndex={0} onClick={() => setWebdavOpen(!webdavOpen)} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); setWebdavOpen(!webdavOpen); } }} className="flex flex-col gap-4 cursor-pointer sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <button
                        ...
                        title="测试 WebDAV 连接"
                        className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-border/60 bg-white/84 text-muted-foreground transition-colors hover:text-foreground disabled:opacity-50 dark:bg-white/5"
                      >
                ...
                <div className="flex items-center justify-end gap-3 sm:justify-normal">
                  ...
                  <div className="rounded-lg border border-border/50 bg-white/72 p-1 text-muted-foreground/50 dark:bg-white/4">{webdavOpen ? <ChevronUp size={12} /> : <ChevronDown size={12} />}</div>
                </div>
              </div>
              {webdavOpen && (
          ...
          <div className="rounded-3xl border border-dashed border-border/70 bg-white/60 px-5 py-4 dark:bg-white/3">
        ...
        <div className="overflow-hidden rounded-3xl border border-border/60 bg-white/75 shadow-sm dark:bg-white/5">
          <div className="flex flex-col gap-2 border-b border-border/50 bg-white/40 px-4 py-4 sm:flex-row sm:items-center sm:justify-between dark:bg-white/3">
            ...
            <div className="rounded-full border border-border/60 bg-white/72 px-3 py-1 text-[10px] font-black uppercase tracking-[0.16em] text-muted-foreground/70 dark:bg-white/4">配额 {backups.length} / {backupRetention}</div>
          </div>
              ...
              <div className="space-y-3 p-4">
                {backups.map((item) => (
                  <div key={item.name} className="rounded-2xl border border-border/50 bg-background/70 px-4 py-4 dark:bg-background/70">
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      <button onClick={() => downloadBackupFile(item.name)} className="inline-flex h-9 flex-1 items-center justify-center gap-1.5 rounded-xl border border-border/60 bg-white/84 text-xs font-black text-primary dark:bg-white/5">
                        <Download size={13} />
                        下载
                      </button>
            ...
            <table className="w-full min-w-[680px] text-left text-[11px]">
              ...
              <tbody className="divide-y divide-border/20">
                {isLoadingBackups ? (
                  ...
                  backups.map((item) => (
                    <tr key={item.name} className="group transition-colors hover:bg-white/20 dark:hover:bg-white/3">
