...
export default function ShopGoodsPage() {
    ...
    try {
      const res = await fetch("/api/products", {
        ...
        body: JSON.stringify({
          ...
          doudianSkuId: formData.doudianSkuId?.trim() || "",
  ...
  const openEditModal = useCallback(async (item: ShopCatalogItem) => {
    ...
    setEditingProduct({
      ...
      meituanSkuId: latestItem.shopMeituanSkuId ?? latestItem.meituanSkuId ?? "",
      meituanSkuIds: latestItem.shopMeituanSkuIds ?? latestItem.meituanSkuIds ?? [],
      taobaoSkuId: latestItem.taobaoSkuId || "",
      doudianSkuId: latestItem.doudianSkuId || "",
  ...
  return (
    <div className="space-y-8">
      ...
      <ProductSelectionModal
        ...
        selectedIds={assignedTemplateIds}
        selectedBadgeLabel="当前店铺已复制"
        title={selectedShop ? `复制到 ${selectedShop.name}` : "复制商品"}
