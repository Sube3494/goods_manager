          ...
          <div className="min-w-0 flex-1">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <button
                ...
                className="inline-flex h-9 w-9 shrink-0 items-center justify-center gap-2 rounded-full border border-border bg-white px-0 text-sm font-bold leading-none text-foreground shadow-sm transition-all hover:border-primary/30 hover:bg-primary hover:text-primary-foreground active:scale-95 dark:border-white/10 dark:bg-white/5 dark:hover:border-white/20 sm:w-auto sm:px-3"
                title="常见问题解答"
              >
                <CircleHelp size={17} />
